        ...
        <header className="space-y-2 border-b border-slate-100 pb-4">
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => {
                window.location.hash = 'request/batch';
              }}
              className="rounded-md border border-primary-600 bg-white px-4 py-2 text-sm font-semibold text-primary-600 transition-colors hover:bg-primary-50"
            >
              배치로 여러 건 업로드
            </button>
          </div>
